...
async def process(files: list[UploadFile]):
    ...
    for file in files:
        ...
        try:
            ...
            return {"error": f"Gagal membaca file {file.filename}"}
...
# fungsi pembersih nama fasilitas
...
def proses_files_gradio(files):
    ...
    center_columns = {'NIK', 'Rekomendasi', 'Jumlah Fasilitas', 'Kol 1', 'Kol 2-5', 'WO/dihapusbukukan', 'LOVI', 'Kolom Update'}
